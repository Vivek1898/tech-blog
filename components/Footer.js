...
const Footer =() =>{
    ...
    return(
        <React.Fragment>
        <footer class="text-center bg-gray-900 text-white" style={{"backgroundColor": "rgb(79 70 229 / 1)"}}>
  ...
  <div class="text-center p-4" style={{"backgroundColor": "rgb(79 70 229 / 1)"}}>
    © 2023 Copyright:
    <a class="text-whitehite" href="https://tailwind-elements.com/">AcodeDaily</a>
  </div>
</footer>
        </React.Fragment>
